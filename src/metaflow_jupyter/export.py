...
def _write_script(flow_name, out_dir):
    """
    ...
    try:
        ...
        with open(dest / f"{flow_name}.py", "w", encoding="utf-8") as f:
            f.write(source)
        print(f"Exported {flow_name} to {dest}/{flow_name}.py")
    except Exception as e:
        print(f"Error exporting {flow_name}: {e}")
